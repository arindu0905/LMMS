...
const Signup = () => {
    ...
    const onSubmit = async e => {
        ...
        try {
            ...
            if (res.data.user?._isMocked || res.data.session) {
                alert('Registration successful! Please log in.');
            } else {
                alert('Registration successful! Please check your email inbox to confirm your account before logging in (Check spam folder if needed!).');
            }
            navigate('/login');
        } catch (err) {
            console.error(err);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                ...
                <div className="bg-white/80 backdrop-blur-lg py-8 px-4 shadow-xl border border-white/50 sm:rounded-xl sm:px-10">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            ...
                            >
                                {isGoogleLoading ? (
                                    <div className="w-5 h-5 mr-3 border-2 border-indigo-600 border-t-transparent rounded-full animate-spin" />
                                ) : (
